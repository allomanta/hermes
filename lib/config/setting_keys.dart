...
enum AppSettings<T> {
  ...
  messagePreviewMaxLines<int>('chat.pantheon.message_preview_max_lines', 50),
  ...
  sendPublicReadReceipts<bool>('chat.pantheon.send_public_read_receipts', true),
  swipeRightToLeftToReply<bool>('chat.pantheon.swipeRightToLeftToReply', true),
