...
import 'package:hermes/pages/call/call_tile.dart';
import 'package:hermes/pages/call/call_view_model.dart';
import 'package:hermes/pages/call/start_time.dart';
import 'package:hermes/pages/call/utils/get_call_tiles.dart';
...
class CallPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tileSize = PantheonThemes.isColumnMode(context) ? 256.0 : 128.0;
