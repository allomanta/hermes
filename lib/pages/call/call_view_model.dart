...
import 'package:hermes/utils/matrix_live_kit_calls/call_keys_event_content.dart';
...
import 'package:hermes/utils/position_from_build_context.dart';
    ...
    try {
      ...
      if (PlatformInfos.isMobile) {
        ...
        callKitId = activeCalls
            ...
            ?.id;
        if (callKitId == null) {
          final params = await buildHermesCallKitParams(room, intent: intent);
