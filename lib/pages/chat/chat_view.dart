...
import 'package:hermes/pages/chat/chat_app_bar_title.dart';
import 'package:hermes/pages/chat/chat_event_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop:
          ...
          !controller.hasOpenChatDetails,
      onPopInvokedWithResult: (pop, _) {
        if (!pop) controller.handleExitEvent();
      },
      child: StreamBuilder(
        ...
        builder: (context, snapshot) => FutureBuilder(
          ...
          builder: (BuildContext context, snapshot) {
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                shape: PantheonThemes.isColumnMode(context)
                    ? Border(
