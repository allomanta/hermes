...
import 'package:hermes/utils/call_kit_params.dart';
...
import 'package:hermes/utils/notification_avatar_extension.dart';
  ...
  final androidPlatformChannelSpecifics = AndroidNotificationDetails(
    ...
    actions: switch (event.type) {
      ...
      EventTypes.Sticker => <AndroidNotificationAction>[
        ...
        AndroidNotificationAction(
          HermesNotificationActions.mute.name,
          l10n.mute,
      ...
      RtcNotificationContent.eventType => [
        AndroidNotificationAction(
          HermesNotificationActions.enterCall.name,
          l10n.enterCall,
...
class HermesPushPayload {
  ...
  factory HermesPushPayload.fromString(String payload) {
    ...
    return HermesPushPayload(parts.first, parts[1], parts[2]);
  }
